...
var versionTable = [152, 272, 440, 640, 864, 1088, 1248, 1552, 1856, 2192, 2592, 2960, 3424, 3688, 4184, 4712];
function showQRCode(text, scale) {
    var dotsize = 5;
    ...
    var QRCodeVersion = 2;
    var space = 100;
    var n = versionTable.length;
    for (var i = 0; i < n; i++)
    {
        if (text.length * 8 + space > versionTable[i])
            QRCodeVersion = i + 2;
        else
            break;
    }
...
function updateQRCode(elementId, text, scale) {
    var element = document.getElementById(elementId);
    var qrImg = showQRCode(text, scale);
    if(element.lastChild)
        element.replaceChild(qrImg, element.lastChild);
    else
